...
Malakias Kosonen
Tehtävä 10.3: Laajennettu Person-luokka
"""
"""
...
class Person:
    ...
    def move(self, address):
        """
        When Denzi moves to different loaction, this method changes it.
        :param address: str, Address before the move
        :return: str, Address after the move
        """
